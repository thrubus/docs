...
<head>
  ...
  <title>Thrubus | Bahan Bakar</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Agen</a></li>
        <li class="active">Bahan Bakar</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-navy">
            <div class="box-header">
              <h3 class="box-title">Bahan Bakar</h3>
              <div class="box-tools">
                <button type="button" class="btn waves-effect waves-light btn-navy btn-sm" data-toggle="modal" data-target="#modal-tambah-pengaturan-harga">
                  <i class="fa fa-plus"></i> Tambah Bahan Bakar
                </button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="bahan-bakar" class="table  ">
                <thead>
                <tr>
                  <th>No.</th>
                  <th>Bahan Bakar</th>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <span data-toggle="modal" data-target="#modal-detail-bahan-bakar">
                    ...
                    <span data-toggle="modal" data-target="#modal-edit-bahan-bakar">
                    ...
                    <span data-toggle="modal" data-target="#modal-nonaktifkan-bahan-bakar">
