...
<head>
  ...
  <title>Thrubus | Paket radius & biaya</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Agen</a></li>
        <li class="active">Paket radius & biaya</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-navy">
            <div class="box-header">
              <h3 class="box-title">Paket radius & biaya</h3>
              <div class="box-tools">
                <button type="button" class="btn waves-effect waves-light btn-navy btn-sm" data-toggle="modal" data-target="#modal-tambah-pengaturan-harga">
                  <i class="fa fa-plus"></i> Tambah Paket radius & biaya
                </button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="paket-radius-dan-biaya" class="table  ">
                <thead>
                <tr>
                  <th>No.</th>
                  <th>Durasi</th>
                ...
                <tr>
                  ...
                  <td class="center">
                    <span data-toggle="modal" data-target="#modal-detail-paket-radius-dan-biaya">
                      <a href="javascript:void(0)" class="btn waves-effect waves-light btn-blue btn-sm" data-content="Tarif" data-toggle="popover" data-trigger="hover" data-placement="top">
                    ...
                    <span data-toggle="modal" data-target="#modal-edit-paket-radius-dan-biaya">
                    ...
                    <span data-toggle="modal" data-target="#modal-hapus-paket-radius-dan-biaya">
...
<script>
  $(function () {
    $('#paket-radius-dan-biaya').DataTable({
      'paging'      : true,
      "language": {
        "paginate": {
          "next": "Selanjutnya",
