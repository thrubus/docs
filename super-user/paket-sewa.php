...
<head>
  ...
  <title>Thrubus | Paket Sewa</title>
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <button type="button" class="btn waves-effect waves-light btn-navy btn-sm" data-toggle="modal" data-target="#modal-tambah-pengaturan-harga">
                  <i class="fa fa-plus"></i> Tambah Paket Sewa
                </button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="paket-sewa" class="table">
                <thead>
                <tr>
                  <th>No.</th>
                  <th>Paket Sewa</th>
                ...
                <tr>
                  <td>1.</td>
                  <td>Drop Off</td>
                  <td>Antar atau jemput satu tujuan</td>
                  <td style="text-align: center;">
                    <span data-toggle="modal" data-target="#modal-detail-paket-sewa">
                    ...
                    <span data-toggle="modal" data-target="#modal-edit-paket-sewa">
                    ...
                    <span data-toggle="modal" data-target="#modal-nonaktifkan-paket-sewa">
