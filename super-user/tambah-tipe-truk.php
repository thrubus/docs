...
<head>
  ...
  <title>Thrubus | Tambah Tipe Truk</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Tipe Truk</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-navy">
              <div class="box-header with-border">
                <h3 class="box-title">Form Tambah Tipe Truk</h3>
              </div>
              <div class="box-body">
                <!-- row -->
                <div class="row no-padding">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;">
                        <option selected="selected">Truk</option>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-field" placeholder="Tipe Truk" name="tipe-truk" id='tipe-truk' required />
                      <span for="tipe-truk" class="form-label-icon-right"><i class="fa fa-car"></i></span>
                      <label for="tipe-truk" class="form-label-float">Tipe Truk</label>
                    </div>
                  </div>
                  <!-- /.col-md-6 -->
                </div>
                ...
                <div class="row no-padding">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="number" class="form-field" placeholder="Lebar Bak" name="lebar-bak" id='lebar-bak' required />
                      <label for="lebar-bak" class="form-label-float">Lebar Bak</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="number" class="form-field" placeholder="Tinggi Bak" name="tinggi-bak" id='tinggi-bak' required />
                      <label for="tinggi-bak" class="form-label-float">Tinggi Bak</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="number" class="form-field" placeholder="Panjang Bak" name="panjang-bak" id='panjang-bak' required />
                      <label for="panjang-bak" class="form-label-float">Panjang Bak</label>
                    </div>
                  </div>
                </div>
                <!-- /.row -->
