...
<head>
  ...
  <title>Thrubus | Daftar Merk</title>
        ...
        <div class="col-xs-12">
          <div class="box box-navy">
            <div class="box-header">
              <h3 class="box-title">Daftar Merk</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="merk" class="table  ">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="http://demo.okkarent.id/mitra/detail-merk.php" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-orange btn-sm" data-content="Edit" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-pencil"></i></a>
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-red btn-sm" data-content="Hapus" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
