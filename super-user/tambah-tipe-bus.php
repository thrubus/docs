...
<head>
  ...
  <title>Thrubus | Tambah Tipe Bus</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Tipe Bus</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-navy">
              <div class="box-header with-border">
                <h3 class="box-title">Form Tambah Tipe Bus</h3>
              </div>
              <div class="box-body">
                <!-- row -->
                <div class="row no-padding">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-field" placeholder="Tipe Bus" name="tipe-bus" id='tipe-bus' required />
                      <span for="tipe-bus" class="form-label-icon-right"><i class="fa fa-car"></i></span>
                      <label for="tipe-bus" class="form-label-float">Tipe Bus</label>
                    </div>
                  </div>
                  <!-- /.col-md-6 -->
                </div>
