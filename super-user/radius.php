            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <button type="button" class="btn waves-effect waves-light btn-navy btn-sm" data-toggle="modal" data-target="#modal-tambah-pengaturan-harga">
                  <i class="fa fa-plus"></i> Tambah Radius
                </button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="radius" class="table  ">
                <thead>
                <tr>
                  <th>No.</th>
                  <th>Radius</th>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <span data-toggle="modal" data-target="#modal-detail-radius">
                    ...
                    <span data-toggle="modal" data-target="#modal-edit-radius">
                    ...
                    <span data-toggle="modal" data-target="#modal-nonaktifkan-radius">
