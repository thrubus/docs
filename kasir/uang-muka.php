        ...
        <section class="col-lg-12 connectedSortable ui-sortable">
          <div class="box box-navy">
            ...
            <div class="box-header with-border ui-sortable-handle" style="cursor: move;">
              <h3 class="box-title">Pembayaran uang muka : </h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover tdcenter thcenter">
                <tbody>
                  <tr>
                    <th>No.</th>
                    <th>Order</th>
                  ...
                  <tr>
                    ...
                    <td><span class="label bg-green">Telah dikonfirmasi</span></td>
                    <td>Arif</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td><span class="label bg-red">Belum dikonfirmasi</span></td>
                    <td>-</td>
                    <td>
                      <a href="detail-pemesanan.php?params=booking" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    </td>
