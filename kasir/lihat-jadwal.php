...
$arr = [
  ...
  'booking' => [
    'button' => '<span data-toggle="modal" data-target="#modal-jadikan-terjadwal">
      <button type="button" class="btn waves-effect waves-light btn-blue btn-sm" data-content="Terjadwal" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-arrow-right"></i></button>
    </span>
    <span data-toggle="modal" data-target="#modal-jadikan-proses">
      <button type="button" class="btn waves-effect waves-light btn-aqua btn-sm" data-content="Proses" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-arrow-right"></i></button>
    </span>  
    <span data-toggle="modal" data-target="#modal-jadikan-cancel">
      <button type="button" class="btn waves-effect waves-light btn-red btn-sm" data-content="Cancel" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-times"></i></button>
    </span>'
  ],
  'terjadwal' => [
  ...
  'proses' => [
    'button' => '<span data-toggle="modal" data-target="#modal-jadikan-close">
      <button type="button" class="btn waves-effect waves-light btn-lime btn-sm" data-content="Close" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-check"></i></button>
    </span>
    <span data-toggle="modal" data-target="#modal-jadikan-cancel">
      <button type="button" class="btn waves-effect waves-light btn-red btn-sm" data-content="Cancel" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-times"></i></button>
    </span>'
