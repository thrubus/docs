...
<div class="">
  ...
  <div class="error-page" style="width: 800px">
    <h3 class="text-center"><i class="fa fa-check text-success"></i> Verifikasi sukses.</h3>

    <p class="text-center">
      Reset password sudah kami kirim ke email Anda, silahkan klik link tautan pada email <b>emailnyaagen@gmail.com</b>
    </p>
  </div>
  <!-- /.error-page -->
</div>
