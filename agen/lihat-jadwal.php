...
$arr = [
  'telepon-masuk' => [
    'button' => '<span data-toggle="modal" data-target="#modal-jadikan-booking">
    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-orange btn-sm" data-content="Booking" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-arrow-right"></i></a>
  </span>'
  ],
  'booking' => [
    'button' => '<span data-toggle="modal" data-target="#modal-jadikan-cancel">
  ...
  'kadaluarsa' => [
    'button' => '<span data-toggle="modal" data-target="#modal-jadikan-booking">
    <button type="button" class="btn waves-effect waves-light btn-orange btn-sm" data-content="Booking" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-book"></i></button>
  </span>'
  ]
]
?>
