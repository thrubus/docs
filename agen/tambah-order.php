...
<head>
  ...
  <title>Thrubus | Tambah Order</title>
    ...
    <section class="content">
      <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <span for="nama" class="form-label-icon-right"><i class="fa fa-user"></i></span>
                      <label for="nama" class="form-label-float">Nama</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <input type="number" class="form-field" placeholder="No. telepon" name="no-telepon" id='no-telepon' required />
                      <span for="no-telepon" class="form-label-icon-right"><i class="fa fa-phone"></i></span>
                  ...
                  <div class="col-md-12">
                    ...
                    <ul class="timeline">
                      <li>
                        ...
                        <div class="form-group">
                          <input readonly type="text" class="form-field" placeholder="Kota / tempat wisata wajib diisi" name="alamat" id='alamat' required />
        ...
        <section class="col-lg-6 connectedSortable ui-sortable">
            ...
            <div class="box-body">
              <table id="daftarkasir" class="table  ">
                ...
                <tr>
                  ...
                  <td><a href="javascript:void(0)">L 8787 NJ</a></td>
          ...
          <div class="box box-navy">
            <div class="box-header">
              <h3 class="box-title">Riwayat Telepon Masuk</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="daftarkasir" class="table  ">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    ...
                    <span data-toggle="modal" data-target="#modal-pilih"><a href="javascript:void(0)" class="btn waves-effect waves-light btn-green btn-sm" data-content="Pilih" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-check"></i></a><span>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
