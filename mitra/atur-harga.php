          ...
          <div class="box box-navy">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <button type="button" class="btn waves-effect waves-light btn-navy btn-sm" data-toggle="modal" data-target="#modal-tambah-pengaturan-harga">
                  <i class="fa fa-plus"></i> Pengaturan Harga Mitra Lain
                </button>
              </div>
            </div>
            <!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <span data-toggle="modal" data-target="#modal">
                        <button type="button" class="btn waves-effect waves-light btn-orange btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top">
