...
<head>
  ...
  <title>Thrubus | Daftar Kasir</title>
              ...
              <table id="daftarkasir" class="table  ">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="detail-kasir.php" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <span data-toggle="modal" data-target="#modal-nonaktifkan"><a href="javascript:void(0)" class="btn waves-effect waves-light btn-red btn-sm" data-content="Nonaktikan" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-ban"></i></a><span>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="detail-kasir.php" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <span data-toggle="modal" data-target="#modal-aktifkan"><a href="javascript:void(0)" class="btn waves-effect waves-light btn-green btn-sm" data-content="Aktifkan" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-check"></i></a><span>
                  </td>
                </tr>
                </tfoot>
              </table>
