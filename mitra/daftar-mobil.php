            ...
            <div class="box-body">
              <table id="daftarmobil" class="table  ">
                ...
                <tr>
                  ...
                  <td><a href="javascript:void(0)">Mitra</a></td>
                  <td><a href="javascript:void(0)">Amin</a></td>
                  <td style="text-align: center;"><span class="badge bg-green">Ready</span></td>
                  <td style="text-align: center;">
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-red btn-sm" data-content="Nonaktikan" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-ban"></i></a>
                  </td>
                </tr>
                <tr>
                  <td>2.</td>
                  ...
                  <td><a href="javascript:void(0)">Suyatno</a></td>
                ...
                <tr>
                  ...
                  <td><a href="javascript:void(0)">Gerry</a></td>
                  <td><a href="javascript:void(0)">Hendry</a></td>
                  <td style="text-align: center;"><span class="badge bg-red">Off</span></td>
                  <td style="text-align: center;">
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <a href="javascript:void(0)" class="btn waves-effect waves-light btn-green btn-sm" data-content="Aktifkan" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-check"></i></a>
                  </td>
                </tr>
                </tfoot>
              </table>
