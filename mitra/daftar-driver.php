...
<head>
  ...
  <title>Thrubus | Daftar Driver</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Daftar Driver</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-navy">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="daftardriver" class="table  ">
                <thead>
                <tr>
                  <th>No.</th>
                  <th>Nama</th>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="http://demo.okkarent.id/mitra/detail-driver.php" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
                    <span data-toggle="modal" data-target="#modal-tangguhkan">
                      <a href="javascript:void(0)" class="btn waves-effect waves-light btn-navy btn-sm" data-content="Tangguhkan" data-toggle="popover" data-trigger="hover" data-placement="top">
                ...
                <tr>
                  ...
                  <td><a href="javascript:void(0)">+62 838 4455 6633</a></td>
                  <td><a href="javascript:void(0)">Jl. Raya Gunung Anyar Jaya no.4, Surabaya.</a></td>
                  <td style="text-align: center;"><span class="badge bg-gray">Ditangguhkan</span></td>
                  <td style="text-align: center;">
                    <a href="http://demo.okkarent.id/mitra/detail-driver.php" class="btn waves-effect waves-light btn-teal btn-sm" data-content="Lihat" data-toggle="popover" data-trigger="hover" data-placement="top"><i class="fa fa-eye"></i></a>
